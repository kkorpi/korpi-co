export type ImageItem = string | { src: string; replay?: boolean };
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: [
      ...
      '/projects/p-simular-1b.webp',
      '/projects/p-simular-2.webp',
    ],    
  ...
  },
  {
    ...
    year: '2023–2024',
    image: '/projects/p-pixel-watch.webp',
  ...
  },
  {
    ...
    year: '2023–2024',
    image: [
      '/projects/branch01.webp',
      '/projects/branch02.webp',
      '/projects/branch03.webp',
      '/projects/branch04.webp',
      '/projects/branch05.webp',
  ...
  },
  {
    ...
    year: '2021-2022',
    image: '/projects/p-katalyst.webp',
  ...
  },
  {
    ...
    year: '2020–2022',
    image: [
      '/projects/p-fonts-1.webp',
      '/projects/p-fonts-2.webp',
      '/projects/p-fonts-3.webp',
    ],
  ...
  },
  {
    ...
    year: '2020–2021',
    image: [
      '/projects/p-mapbox-1.webp',
      '/projects/p-mapbox-2.webp',
    ],
...

  {
    ...
    year: '2019',
    image: '/projects/p-skinclinical.webp',
  ...
  {
    title: 'Spare5',
    description: 'Human-in-the-loop platform for high-quality ML training data.',
    year: '2017',
    image: '/projects/p-spare5.webp',
    imageAlt: 'Human-in-the-loop platform for high-quality ML training data.',  // optional
    details:
      'Spare5 was built around human-in-the-loop labeling for ML training data: the messy, judgment-heavy work that anonymous crowds couldn\'t reliably produce. Vetted, skilled contributors (writers, photographers, video editors, native speakers) earned small payouts on tasks that needed real judgment: writing image descriptions for Getty, trimming GoPro footage, calling hotels to verify Expedia listings. The design problem was making short, skilled tasks feel respectful and worth doing on both sides while producing the kind of clean, labeled data ML teams could actually train on. The company later rebranded as Mighty AI and was acquired by Uber for its self-driving training-data work.',
  },
  {
    title: 'Microsoft Research',
    description: 'Design on Microsoft\'s first conversational AI platform.',
    year: '2015–2017',
    image: '/projects/p-msft.webp',
  ...
  },
  {
    ...
    year: '2013–2015',
    image: [
      '/projects/p-dialer-1.webp',
      '/projects/p-dialer.webp',
    ],
  ...
  },
  {
    ...
    year: '2006–2010',
    image: '/projects/p-googleads.webp',
